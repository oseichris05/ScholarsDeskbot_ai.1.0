...
#     welcome_text = (
#         "🎓 Welcome to ScholarDeskBot!\n\n"
#         "This bot helps you purchase checkers, apply for university forms, access educational resources, "
#         "track referrals, and interact with ScholarDeskAi.\n\n"
#         "Use the menu below to get started!"
#     )
#     main_keyboard = {
#         "keyboard": [
...
#
# def route_message(update):
#     # If callback query, pass to callback handler.
...
#         handle_start_command(chat_id)
#         return
#     # For simplicity, we call Buy Checker when user sends "buychecker"
#     if normalized_text == "buychecker":
#         from menus.buy_checker.select_checker import handle_checker_selection
#         handle_checker_selection(chat_id)
#         return
#     send_message(chat_id, "Sorry, I didn't understand that command.")
...
def route_message(update):
    ...
    # If there is an active session, route input there.
    if get_session(chat_id) is not None:
        # Example: If you're using a registration flow:
        from menus.registration.registration_handler import process_registration_input
        process_registration_input(chat_id, text)
        return

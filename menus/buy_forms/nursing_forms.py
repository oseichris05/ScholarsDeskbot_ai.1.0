# # menus/buy_forms/nursing_forms.py
...
# def handle_nursing_forms_purchase(chat_id, callback_query_id=None, message_id=None):
#     quantity = 1
#     form_type = "nursing_forms"
...
#     if not info:
#         send_message(chat_id, "Error: No info available for Nursing Forms.")
#         return
#     available_stock = info.get("available_stock", 0)
#     if available_stock < 1:
#         send_message(
#             chat_id, "Sorry, the chosen nursing form is out of stock.")
#         return
...
#         if not forms:
#             send_message(
#                 chat_id, "Sorry, the chosen nursing form is no longer available.")
...
#             f"Your payment of {total_price:.2f} cedis for 1 Nursing Form is confirmed.\n\n"
#             f"*Your Form Details:*\n{details}\n\n"
#             f"Transaction ID: {transaction_id}\n\n"
